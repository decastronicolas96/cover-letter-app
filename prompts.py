...
Paragraph 2 (THEMATIC CAPABILITY & PRIMARY PROOF): Max 6 sentences. Open the paragraph by explicitly mapping your high-level experience to the most critical requirement of the role (e.g., "The [Role Title] sits at the intersection where I have spent my career: [High-level capability]"). Then, rapidly synthesize specific evidence to prove that claim. Use metrics, scale (e.g., Treinta's 1M+ users), and named technologies from the stories. DO NOT narrate the deep backstory or the STAR method of a single narrow project. Synthesize the most impressive impacts (even from multiple roles if relevant) to prove the overarching theme.
Paragraph 3 (SECOND DIMENSION/COMPLEMENTARY SKILL): Max 5 sentences. Introduce a second high-level capability required by the JD (e.g., technical depth, cross-functional leadership, or consulting rigor). Prove it instantly with 1-2 rapid examples (e.g., "The broader platform strategy experience comes from Treinta..." or "On the consulting side, my time at Mastercard was spent..."). Again, abstract your experience to match the role perfectly, and back it up with hard metrics, avoiding narrow step-by-step project storytelling.
